					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$category = $conn->query("SELECT * FROM account_type order by id asc");
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $row['name'] ?>" data-notes="<?php echo $row['notes'] ?>">Edit</button>
