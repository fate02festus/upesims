		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				...
				<select name="acc_type" id="" class="custom-select select2">
					<option value=""></option>
					<?php 
					$house = $conn->query("SELECT * FROM account_type where id not in (select acc_type from banker_account where banker='$accno')");
			...
			<div class="col-md-4">
				<label for="" class="control-label">A/C No. #</label>
				<input type="text" class="form-control" name="bacc"  value="<?php echo isset($ln) ? $ln :'' ?>" required>
			</div>
