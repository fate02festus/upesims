                            ...
                            <div class="card border-primary">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM sys_users")->num_rows ?>
                                        </b></h4>
                                        <p><b>Total Users</b></p>
                                    </div>
                                </div>
                            ...
                            <div class="card border-warning">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM account_type ")->num_rows ?>
                                        </b></h4>
                                        <p><b>Total Account Types</b></p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=sys_user" class="text-primary float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-success">
                                <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php 
                                             $payment = $conn->query("SELECT sum(balance) as paid FROM banker_account "); 
                                             echo $payment->num_rows > 0 ?  number_format($payment->fetch_array()['paid'],2) : 0;
                                             ?>
                                        </b></h4>
                                        <p><b>Bank Balance</b></p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="#" class="text-primary float-right">View Balance <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
